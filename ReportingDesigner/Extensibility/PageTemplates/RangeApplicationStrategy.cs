...
{
    public class RangeApplicationStrategy:TemplateApplicationStrategy
    {
        public override void ApplyTemplate(TemplateApplicationEventArgs args,DesignerContainer designer)
        {
            ...
            foreach (var pageViewModel in reportViewModel.Pages.Where(p => p.PageNumber >= args.StartPage && p.PageNumber <= args.EndPage))
            {
        ...
        public override void UnapplyTemplate(TemplateApplicationEventArgs args, DesignerContainer designer)
        {
            ...
            //grab all the page view models
            //that fall within the range specified
            //by the start page and end page
            var pages =
                designer.ViewModel.Pages.Where(p => p.PageNumber >= args.StartPage && p.PageNumber <= args.EndPage);
