...
{
    public class EvenPagesApplicationStrategy:TemplateApplicationStrategy
    {
        public override void ApplyTemplate(TemplateApplicationEventArgs args,DesignerContainer designer)
        {
            ...
            foreach (var pageViewModel in reportViewModel.Pages.Where(p => p.PageNumber % 2 == 0))
            {
        ...
        public override void UnapplyTemplate(TemplateApplicationEventArgs args, DesignerContainer designer)
        {
            ...
            var pages =
                designer.ViewModel.Pages.Where(p => p.PageNumber % 2 == 0);
